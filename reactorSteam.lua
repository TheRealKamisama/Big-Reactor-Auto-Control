...
function setGraphs()
  graphs["tick"] = { x = 8, y = 6, width = 73, height= 8, title = "STEAM LAST TICK"}
  graphs["stored"] = { x = 8, y = 16, width = 73, height = 8, title = "STEAM STORED"}
  graphs["rods"] = { x = 8, y = 26, width = 73, height= 8, title = "CONTROL RODS LEVEL"}
end

function setInfos()
  infos["tick"] = { x = 92, y = 28, width = 73, height= 1, title = "STEAM PER TICK : ", unit = " mb"}
  infos["stored"] = { x = 92, y = 30, width = 73, height = 1, title = "STEAM STORED : ", unit = " mb"}
...
function getInfoFromReactor()
  reactor.stats["tick"] = math.ceil(reactor.getHotFluidProducedLastTick())
  reactor.stats["stored"] = reactor.getHotFluidAmount()
...
function draw()
  ...
  if currentRF ~= reactor.stats["stored"] then
    currentRF = reactor.stats["stored"]
    local max = math.ceil(graphs["stored"].width * (currentRF/MAXsteam))
